package com.fuzs.puzzleslib_br;

import com.fuzs.puzzleslib_br.capability.CapabilityController;
import com.fuzs.puzzleslib_br.element.AbstractElement;
import com.fuzs.puzzleslib_br.element.ElementRegistry;
import com.fuzs.puzzleslib_br.element.side.ISidedElement;
import com.fuzs.puzzleslib_br.network.NetworkHandler;
import com.fuzs.puzzleslib_br.proxy.IProxy;
import com.fuzs.puzzleslib_br.recipe.ElementConfigCondition;
import com.fuzs.puzzleslib_br.registry.RegistryManager;
import com.fuzs.puzzleslib_br.util.PuzzlesLibUtil;
...
public class PuzzlesLib {
    ...
    public static final String MODID = "puzzleslib_br";
    ...
    /**
     * load {@link com.fuzs.puzzleslib_br.recipe.ElementConfigCondition} in case this element is adding any recipes
     */
