package com.fuzs.puzzleslib_br.element;

import com.fuzs.puzzleslib_br.PuzzlesLib;
import com.fuzs.puzzleslib_br.config.option.ConfigOption;
...
import com.fuzs.puzzleslib_br.element.side.IServerElement;
...
public abstract class AbstractElement extends EventListener implements IConfigurableElement, IRegistryElement<AbstractElement> {
    ...
    /**
     * empty element needed for some aspects of {@link com.fuzs.puzzleslib_br.config.ConfigManager}
     */
